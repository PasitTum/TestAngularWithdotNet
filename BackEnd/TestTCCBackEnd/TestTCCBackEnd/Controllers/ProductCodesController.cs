...
public class ProductCodesController : ControllerBase
{
    ...
    /// <summary>GET /api/productcodes — ดึงรายการรหัสสินค้าทั้งหมด</summary>
    [HttpGet]
    ...
    /// <summary>POST /api/productcodes — เพิ่มรหัสสินค้า</summary>
    [HttpPost]
    public async Task<IActionResult> Add([FromBody] ProductCodeRequest request)
    {
    ...
    /// <summary>DELETE /api/productcodes/{id} — ลบรหัสสินค้า</summary>
    [HttpDelete("{id:int}")]
